...
INPUT_DIR="${INPUT_DIR:-${DEVICE_DIR}/inputs/vision}"
OUTPUT_DIR="${OUTPUT_DIR:-${DEVICE_DIR}/outputs/vision}"
...
adb shell "export ADSP_LIBRARY_PATH=${DEVICE_DIR} && \
  ...
  ./qnn-net-run \
    ...
    --retrieve_context encoders/vision_encoder_fp16.bin \
